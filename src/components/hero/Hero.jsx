...
const PrevArrow = (props) => {
  ...
  return (
    <div
      className="absolute bg-black md:bg-white text-white md:text-primary rounded-full md:rounded-none bottom-[70%] right-[79%] md:bottom-0 md:right-[50.1%] slider-btn z-10"
      onClick={onClick}
    >
      <button className="next">
